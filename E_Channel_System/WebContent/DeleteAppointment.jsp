...
<body>
  ...
  <div class="menu-bar">
   ...
   <form action="delete" method= "post"  >
       ...
       <input type="text" id="pname" name="pname" value="<%=name%> " readonly><br><br>

       <label for="padd">Patient Address</label><br>
       <input type="text" id="padd" name="paddress" value="<%=address%>" readonly><br><br>
       
       <label for="age">Age</label><br>
       <input type="text" id="age" name="age" value="<%=age%>" readonly><br><br>
       
       <label for="dname">Doctor Name</label><br>
       <input type="text" id="dname" name="dname" value="<%=docname%>" readonly><br><br>

      <label for="spec">Select Specialist</label><br>
      <select id="spec" name="spec" value="<%=spec%>"  disabled>
      ...
      <select id="medi" name="medi" value="<%=mcenter%>" disabled>
       ...
       <input type="date" id="bdate" name="bdate" value="<%=adate%>" readonly><br><br>
       
        <label for="btimee">Booking Time</label><br>
       <input type="time" id="btime" name="btime" value="<%=atime%>"  readonly><br><br>
       
   
    <input type="submit" value="Delete appointment" onclick = "myfunction()">
  </form>
</div> 
